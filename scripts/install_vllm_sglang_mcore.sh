...
wget -nv https://ghfast.top/https://github.com/Dao-AILab/flash-attention/releases/download/v2.7.4.post1/flash_attn-2.7.4.post1+cu12torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl && \
...
wget -nv https://ghfast.top/https://github.com/flashinfer-ai/flashinfer/releases/download/v0.2.2.post1/flashinfer_python-0.2.2.post1+cu124torch2.6-cp38-abi3-linux_x86_64.whl && \
...
if [ $USE_MEGATRON -eq 1 ]; then
    ...
    NVTE_FRAMEWORK=pytorch pip3 install --no-deps git+https://ghfast.top/https://github.com/NVIDIA/TransformerEngine.git@v2.2.1
    pip3 install --no-deps git+https://ghfast.top/https://github.com/NVIDIA/Megatron-LM.git@core_v0.12.2
fi
